...
if(document.getElementById("clickCanvas")) {
    ...
    var COLOURS = [ "#800080", "#000000", "#7c38e3", "#6d4c93", "#00FFFF", "#0000FF", "#6600ff" ];
    var particles = [];
    var pool = [];
    ...
    document.addEventListener("mousedown", function(e) {
        var max, j;
        "TEXTAREA" !== e.target.nodeName && "INPUT" !== e.target.nodeName && "A" !== e.target.nodeName && "I" !== e.target.nodeName && "排除" !== e.target.nodeName 
        && function() {
